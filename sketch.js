...
function preload()
{
  bg_img = loadImage('jungle_background.jpg')
  food = loadImage('banana.png');
  elephant = loadImage('elephant_happy.png');
  elephant= loadImage("elephant_eating.png")
  elephant=loadImage("elephant_sad.png")
  ...
  sad_sound = loadSound("sad_elephant.wav")
  cut_sound = loadSound('rope_cut.mp3');
  eating_sound = loadSound('eating_sound.mp3');
  air = loadSound('air_blow.wav');
...
blower.mouseClicked(airBlow)
 ...
 elephant = createSprite(200,height-80,100,100);
  elephant.scale = 0.2;

  elephant.addAnimation('blinking',blink);
  elephant.addAnimation('eating',eat);
  elephant.addAnimation('crying',sad);
...
function draw() 
{
  ...
  if(collide(fruit,elephant,80)==true)
  {
    World.remove(engine.world,fruit);
    fruit = null;
   elephant.changeAnimation('eating');
    eating_sound.play();
  }
...
if(collide(fruit,star2,20)==true){
  ...
  {
    elephant.changeAnimation('crying');
    bk_song.stop();
    sad_sound.play();
    fruit=null;
   }
